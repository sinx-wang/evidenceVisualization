      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            <p className={classes.text}>案号：xxx <br />&nbsp;&nbsp;&nbsp;&nbsp;案件名称：xxx <br />承办人：xxx </p>
          </Paper>
        </Grid>
        <Grid item xs={6}><label>原告证据:</label>
        ...
        <Grid item xs={6}><label>被告证据:</label>
          <Paper className={classes.paper2}>
            <textarea className={classes.textarea}
            ...
            <form noValidate autoComplete="off">
              {
                values.complainantEvidenceList.map((evidenceItem, index) => (
                  <div>
                    <TextField className={classes.evidenceItem} id="outlined-basic" variant="outlined"
